...
def read_squad_examples(input_file, is_training):
    ...
    for entry in input_data:
        for paragraph in entry["paragraphs"]:
            paragraph_text = paragraph["context"] + ' nan'
            doc_tokens = []
            char_to_word_offset = []
            ...
            for qa in paragraph["qas"]:
                ...
                if is_training:
                    if len(qa["answers"]) != 1:
                        orig_answer_text = 'nan'
                        start_position = char_to_word_offset[len(paragraph_text)-3]
                        end_position = char_to_word_offset[len(paragraph_text)-1]
                        # raise ValueError(
